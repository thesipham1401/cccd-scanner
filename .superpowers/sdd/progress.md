...
- WEB APP (user request: free iPhone option, no Mac/fee): added cccdscanner/index.html — a
  ...
  with doPost. Web QR-parse logic verified against Dart with a Node test (10/10).
  Docs: webapp-setup.md (configure + free hosting via Netlify Drop / GitHub Pages).
  Tradeoff documented: web loses auto-OCR + image import; QR happy-path intact.
